...
namespace youcode_p_3
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        private ArrayList validateApprenant()
        {
            ...
            Apprenant apprenant = new Apprenant(tbNom.Text, tbPrenom.Text, object.Request["dtpDN"], numTel, tbAdrs.Text, tbMail.Text, cbPays.Text, cbVille.Text, cbSp.Text);
            //
        ...
        private void initForm()
        {
            ...
            dtpDN.SelectedDate = DateTime.Now;
        }
        ...
        protected void cbPays_SelectedIndexChanged(object sender, EventArgs e)
        {
            string[] payS = { "Maroc", "France" };
        ...
        protected void cbIds_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (executed)
            {
                try
                {
                    ...
                    while (sdr.Read())
                    {
                        ...
                        dtpDN.SelectedDate = DateTime.Parse(sdr["dateNaissance"].ToString());
